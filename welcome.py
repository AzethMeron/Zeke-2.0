...
cmd.Add(triggers.parser, "welcome", parser_welcome, "Setup welcome messages", "", discord.Permissions.all())
...
cmd.Add(triggers.parser, "farewell", parser_farewell, "Setup farewell messages", "")
